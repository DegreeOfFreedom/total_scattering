...
def f_pb(x,pi4):
    ...
    f_Pb= 32.505650*np.exp(1.047035*(x/pi4)**2)+20.014240*np.exp(6.670321*(x/pi4)**2)+ \
        14.645669*np.exp(0.105279*(x/pi4)**2)+ 5.029499*np.exp(16.525040*(x/pi4)**2) + \
        1.760138*np.exp(0.105279*(x/pi4)**2) + 4.044678
