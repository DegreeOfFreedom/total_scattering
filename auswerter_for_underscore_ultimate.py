...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan 24 14:27:21 2020
...
def auswerter(path):
    ...
    for file in root_folder:
        config = np.loadtxt(file,dtype='string')
        ...
        for file_path in file_list:
            ...
            angle_str = os.path.basename(file_path).replace(name_string,'')[:-6]
...
path = '/home/anon/Dokumente/Studium/Masterarbeit/conf3/'
auswerter(path)
